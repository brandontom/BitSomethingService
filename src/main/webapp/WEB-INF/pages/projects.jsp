...
<html lang="en">
  <head>
    ...
    <title>BitSomething Projects</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="masthead">
        <h3 class="text-muted">BitSomething</h3>
      ...
      <div class="jumbotron jumbotron-color">
        ...
        <p class="lead">This is not yet implemented, but i hope you feel happy that you were able to get here!</p>
      </div>

      <!-- Site footer -->
      <footer class="footer">
        <p>&copy; Brandon &#38; Keri 2017</p>
      </footer>
